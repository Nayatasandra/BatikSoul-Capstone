                ...
                <?= $validation->getError('kode'); ?>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="date" class="form-control <?= ($validation->hasError('tanggal_produksi')) ? 'is-invalid' : ''; ?>" id="tanggal_produksi" name="tanggal_produksi" autofocus value="<?= old('tanggal_produksi'); ?>">
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="date" class="form-control <?= ($validation->hasError('tanggal_expired')) ? 'is-invalid' : ''; ?>" id="tanggal_expired" name="tanggal_expired" autofocus value="<?= old('tanggal_expired'); ?>">
                            <div class="invalid-feedback">
