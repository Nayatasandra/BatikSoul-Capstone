            ...
            <form action="/produk/update/<?= $produk['id']; ?>" method="POST" enctype="multipart/form-data"><?= csrf_field(); ?>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" class="form-control <?= ($validation->hasError('tanggal_produksi')) ? 'is-invalid' : ''; ?>" id="tanggal_produksi" name="tanggal_produksi" autofocus value="<?= date('Y/m/d') ?>">
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group col-md-6">
                        <label for="tanggal_expired"><strong>Tanggal Expired </strong></label>
                        <input type="date" class="form-control <?= ($validation->hasError('tanggal_expired')) ? 'is-invalid' : ''; ?>" id="tanggal_expired" name="tanggal_expired" autofocus value="<?= $produk['tanggal_expired']; ?>">
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="form-group">
                            <select name="jenis" class="select2_single form-control">
                                ...
                                <option value="1" <?php if ($validation == '1') echo 'Selected'; ?>> Bakery</option>
                                <option value="2" <?php if ($validation == '2') echo 'Selected'; ?>> Pastry</option>
                                <option value="3" <?php if ($validation == '2') echo 'Selected'; ?>> Lain-lain</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="form-group">
                        <select name="ukuran" class="select2_single form-control">
                            <option value="1" <?php if ($validation == '1') echo 'Selected'; ?>> --Ukuran Roti--</option>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control <?= ($validation->hasError('hargaJual')) ? 'is-invalid' : ''; ?>" id="hargaJual" name="hargaJual" autofocus value="<?= $produk['hargaJual']; ?>">
                        <div class="invalid-feedback">
