...
<nav class="navbar navbar-expand-lg " id="navbar">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
            ...
            <li class="nav-item ">
                <a class="nav-link active" aria-current="page" href="#benefit">Kontak</a>
            </li>
        </ul>
        <div class="icons">
                ...
                <div class="row">
                    <div class="col-md-4 mb-5">
                        <div class="card h-100 shadow border-0">
                            <img class="card-img-top" src="<?php echo base_url('img/benefit/1.jpg'); ?>" alt="..." />
                    ...
                    <div class="col-md-4 mb-5">
                        <div class="card h-100 shadow border-0">
                            <img class="card-img-top" src="<?php echo base_url('img/benefit/2.jpg'); ?>" alt="..." />
                            <div class="card-body p-5">
                    ...
                    <div class="col-md-4 mb-5">
                        <div class="card h-100 shadow border-0">
                            <img class="card-img-top" src="<?php echo base_url('img/benefit/3.jpeg'); ?>" alt="..." />
                            <div class="card-body p-5">
