                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($laporan as $row) : ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;"><?= $row['kode_karyawan']; ?></td>
                                                    <td style="text-align: center;"><?= $row['nama']; ?></td>
                                                    <td style="text-align: center;"><?= $row['tanggal']; ?></td>
                                                    <td style="text-align: center;"><?= $row['jumlah_lembur']; ?></td>
                                                    <td style="text-align: center;"><?= $row['uang_lembur']; ?></td>
                                                    <td style="text-align: center;"><?= $row['tunjangan']; ?></td>
                                                    <td style="text-align: center;"><?= $row['gaji_pokok']; ?></td>
                                                    <?php $totalHarga = $row['jumlah_lembur'] * $row['uang_lembur'] + $row['tunjangan']+ $row['gaji_pokok']; ?>
