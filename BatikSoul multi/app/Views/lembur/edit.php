...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary"> <i class="fas fa-fw  fa-user-circle"></i> Form Edit Data Lembur</h6>
    </div>
    <div class="card-body">

    <form action="/lembur/update/<?= $lembur['id']; ?>" method="POST" enctype="multipart/form-data">
            <?= csrf_field(); ?>
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control <?= ($validation->hasError('tanggal')) ? 'is-invalid' : ''; ?>" id="tanggal" name="tanggal" autofocus value="<?= $lembur['tanggal']; ?>">
                <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control <?= ($validation->hasError('jumlah_lembur')) ? 'is-invalid' : ''; ?>" id="jumlah_lembur" name="jumlah_lembur" autofocus value="<?= $lembur['jumlah_lembur']; ?>">
                <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control <?= ($validation->hasError('uang_lembur')) ? 'is-invalid' : ''; ?>" id="uang_lembur" name="uang_lembur" autofocus value="<?= $lembur['uang_lembur']; ?>">
                <div class="invalid-feedback">
